...
- `docs/plans/PLAN_PAIR_ARB_V3_2_ZH.md` — 单 round 6 大新发现（F1-F6 实证）
- `docs/plans/PLAN_PAIR_ARB_V3_1_ZH.md` — 三层架构基线（v3.3 仍引用其设计）
- `docs/plans/PLAN_PAIR_ARB_V3_ZH.md` — v3 (superseded)
- `docs/plans/PLAN_Codex.md` — 研究方法论来源（v3.3 吸收其分层与证伪原则）
...
- v3.3 上线前 待补：
  - `docs/strategies/STRATEGY_TRANCHE_ARB_ZH.md`（行为规范文档 v1，Codex Stage 3 产物）
  - `docs/runbooks/GO_LIVE_TRANCHE_ARB_CHECKLIST_ZH.md`
