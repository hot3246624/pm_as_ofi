...
| `xuan_ladder_v1` | 最新 xuan public 行为 shadow 近似 | 开盘后 4s 开始；收盘前 25s 停新 first leg；seed pair cap `1.040`；early/late completion cap `1.040/1.080`；taker-close cap `1.000`；clip 随轮内时间梯度变化 |
