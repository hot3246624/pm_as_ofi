...
export PM_RECORDER_ENABLED="${PM_LOCAL_AGG_RECORDER_ENABLED:-false}"
export PM_RECORDER_MARKET_MODE="${PM_RECORDER_MARKET_MODE:-ops_only}"
export PM_INSTANCE_ID="$INSTANCE_ID"
export PM_LOG_ROOT="$LOG_ROOT"
export PM_RECORDER_ROOT="$RECORDER_ROOT"
export PM_LOCAL_AGG_COMPACT_EVIDENCE_ENABLED="${PM_LOCAL_AGG_COMPACT_EVIDENCE_ENABLED:-true}"
export PM_LOCAL_AGG_COMPACT_EVIDENCE_ROOT="${PM_LOCAL_AGG_COMPACT_EVIDENCE_ROOT:-$ROOT/data/compact_evidence/$INSTANCE_ID}"
export PM_LOCAL_PRICE_AGG_BOUNDARY_TAPE_ENABLED="${PM_LOCAL_PRICE_AGG_BOUNDARY_TAPE_ENABLED:-false}"
...
echo "  PM_LOCAL_AGG_COMPACT_EVIDENCE_ENABLED=$PM_LOCAL_AGG_COMPACT_EVIDENCE_ENABLED"
echo "  PM_LOCAL_AGG_COMPACT_EVIDENCE_ROOT=$PM_LOCAL_AGG_COMPACT_EVIDENCE_ROOT"
echo "  PM_LOCAL_PRICE_AGG_BOUNDARY_TAPE_ENABLED=$PM_LOCAL_PRICE_AGG_BOUNDARY_TAPE_ENABLED"
...
echo "  PM_RECORDER_ENABLED=$PM_RECORDER_ENABLED"
