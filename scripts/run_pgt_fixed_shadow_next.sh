...
BASE_INSTANCE_ID="${PM_INSTANCE_ID:-pgt-fixed-${POLYMARKET_MARKET_SLUG}}"
FIXED_INSTANCE_PER_ROUND="${PM_PGT_FIXED_INSTANCE_PER_ROUND:-false}"
case "$FIXED_INSTANCE_PER_ROUND" in
  1|true|True|TRUE|yes|Yes|YES|on|On|ON)
    INSTANCE_ID="${BASE_INSTANCE_ID}-${POLYMARKET_MARKET_SLUG##*-}"
    LOG_ROOT="${PM_LOG_ROOT:-$ROOT/logs/$BASE_INSTANCE_ID}/${POLYMARKET_MARKET_SLUG##*-}"
    RECORDER_ROOT="${PM_RECORDER_ROOT:-$ROOT/data/recorder/$BASE_INSTANCE_ID}/${POLYMARKET_MARKET_SLUG##*-}"
    ;;
  *)
