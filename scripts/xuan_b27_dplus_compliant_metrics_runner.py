#!/usr/bin/env python3
"""Run D+ passive/passive metrics on compliant local backtest inputs.
...
The embedded residual-cooldown profiles make the prior completion-only probe
reproducible under a declared strict/cache + completion + public-audit path.
"""
