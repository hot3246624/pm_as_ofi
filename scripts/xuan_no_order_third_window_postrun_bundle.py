...
def main() -> None:
    ...
    paths = {
        ...
        "source_caveat_audit": scorecard_dir / f"no_order_{args.tag}_source_caveat_audit.json",
    ...
    commands = [
        ...
        [
            sys.executable,
            "scripts/xuan_soft_mainline_source_caveat_audit.py",
            "--output-root",
            str(third_root),
            "--event-diagnostics",
            str(paths["event_diagnostics"]),
            ...
            "--markdown-output",
            str(output_dir / "SOFT_MAINLINE_SOURCE_CAVEAT_AUDIT.md"),
        ],
        [
            sys.executable,
